...
namespace Leto.Alerts
{
    ...
    {
        public AlertException() : this(AlertLevel.Fatal, AlertDescription.internal_error, string.Empty)
        { }

        public AlertException(string message) : this(AlertLevel.Fatal, AlertDescription.internal_error, message)
        { }
