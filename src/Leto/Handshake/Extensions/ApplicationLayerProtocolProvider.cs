...
namespace Leto.Handshake.Extensions
{
    public class ApplicationLayerProtocolProvider
    {
        ...
        public void WriteExtension(ref WriterWrapper writer, ApplicationLayerProtocolType negotiatedAlpn)
        {
        ...
        internal int GetExtensionSize(ApplicationLayerProtocolType negotiatedAlpn)
        {
            var buff = GetBufferForProtocol(negotiatedAlpn);
            return Unsafe.SizeOf<ExtensionType>() + buff.Length + sizeof(byte) * 2;
        }
