...
{
    public abstract class ConnectionState : IConnectionState, IKeyPair, IDisposable
    {
        protected AeadBulkCipher _readKey;
        protected AeadBulkCipher _writeKey;
        protected AeadBulkCipher _storedKey;
        ...
        public SecurePipeConnection Connection
        {
            get => _connection;
            set
            {
                _connection = value;
                _cryptoProvider = _connection.Listener.CryptoProvider;
            }
        }
        ...
        internal RecordHandler RecordHandler => Connection.RecordHandler;

        public abstract TlsVersion RecordVersion { get; }
        ...
        protected TlsVersion GetVersion(ref ServerHelloParser helloParser) => MatchVersionOrThrow(helloParser.TlsVersion);
        ...
        public abstract void ChangeCipherSpec();
