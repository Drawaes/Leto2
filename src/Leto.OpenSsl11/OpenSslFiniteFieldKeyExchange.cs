...
namespace Leto.OpenSsl11
{
    public class OpenSslFiniteFieldKeyExchange : IKeyExchange
    {
        ...
        public int ClientSendSize => throw new NotImplementedException();

        public void PublicKeySpan(Span<byte> span)
        {
                GenerateKeys(null, null);
                DH_get0_key(_localKey, out var pub, out var priv);
                var size = BN_bn2binpad(pub, span);
        }
        ...
        public void SetCertificate(ICertificate certificate) => throw new NotImplementedException();
